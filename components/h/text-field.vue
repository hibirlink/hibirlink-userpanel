...
const emit = defineEmits(["update:modelValue", "locationAdd"]);
...
<template>
  <div class="w-full">
    <slot name="label"
      ><h4 :class="props.labelClass" class="text-gray font-bold">
        {{ label }}
      </h4></slot
    >
    <div
    ...
    >
      ...
      <input
        ...
        class="block w-full h-full border-[1.5px] border-gray-light hover:border-lemon focus:border-green400 rounded-lg bg-transparent text-secondary px-4 focus:outline-none hover:outline-none outline-none transition-all ease-in-out duration-300"
      ...
      >
        <component
          class="h-5 w-5 hover:text-green400 transition-all ease-in-out duration-300"
